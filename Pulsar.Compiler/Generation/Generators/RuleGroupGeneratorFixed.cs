...
namespace Pulsar.Compiler.Generation.Generators
{
    public class RuleGroupGeneratorFixed
    {
        ...
        )
        {
            ...
            sb.AppendLine("                Logger.LogInformation(\"Sent message to channel {Channel}: {Message}\", channel, message);");
            sb.AppendLine("            }");
            sb.AppendLine("            catch (Exception ex)");
            sb.AppendLine("            {");
            sb.AppendLine("                Logger.LogError(ex, \"Failed to send message to channel {Channel}\", channel);");
            sb.AppendLine("            }");
            sb.AppendLine("        }");
