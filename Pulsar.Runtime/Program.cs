    ...
    public class Program
    {
        public static async Task<int> Main(string[] args)
        {
            ...
            try
            {
                ...
                // We'll implement this method that will load the generated rules
                var coordinator = LoadRuleCoordinator(logger, bufferManager);
        ...
        private static void ValidateConfig(RuntimeConfig config, bool requireSensors = true)
        {
