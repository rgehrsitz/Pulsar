...
namespace Pulsar.Tests.RuntimeValidation
{
    ...
    public class TemporalRuleTests : IClassFixture<RuntimeValidationFixture>
    {
        ...
        public async Task RateOfChange_CalculatesCorrectly()
        {
            ...
            Assert.True(outputs2.ContainsKey("output:rate_of_change"), "Output should contain rate_of_change key");
        ...
        public async Task PreviousValues_AccessibleInExpressions()
        {
            ...
            Assert.True(outputs3.ContainsKey("output:average"), "Output should contain average key");
        ...
        public async Task CircularBuffer_HandlesBufferLimits()
        {
            ...
            Assert.True(finalOutputs.ContainsKey("output:oldest_value"), "Output should contain oldest_value key");
            ...
            Assert.True(oldestValue > baseValue, "Oldest value should not be the initial value (should be dropped from buffer)");
        }
        ...
        private string GenerateRateOfChangeRule()
        {
            ...
            sb.AppendLine("rules:");
            sb.AppendLine(@"  - name: 'RateOfChangeRule'
    ...
    actions:
      ...
      - set_value:
        ...
        private string GeneratePreviousValuesRule()
        {
            var sb = new StringBuilder();
            sb.AppendLine("rules:");
            sb.AppendLine(@"  - name: 'PreviousValuesRule'
    ...
    actions:
      ...
      - set_value:
        ...
        private string GenerateMaxBufferRule()
        {
            var sb = new StringBuilder();
            sb.AppendLine("rules:");
            sb.AppendLine(@"  - name: 'BufferLimitRule'
