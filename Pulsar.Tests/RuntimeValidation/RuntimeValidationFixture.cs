...
";
        ...
        public async Task<(bool success, Dictionary<string, object>? outputs)> ExecuteRules(Dictionary<string, object> inputs)
        {
            try
            {
                ...
                var redisConfigType = _compiledAssembly.GetType("Beacon.Runtime.Services.RedisConfigurationuration");
                if (redisConfigType == null)
                {
                    _logger.LogError("RedisConfigurationuration type not found in compiled assembly");
                    return (false, null);
                }
                ...
                if (redisConfig == null)
                {
                    _logger.LogError("Failed to create RedisConfigurationuration instance");
                    return (false, null);
                }
                ...
                {
                    _logger.LogError("Endpoints property not found in RedisConfigurationuration");
                    return (false, null);
                }
