...
namespace Pulsar.Tests.Integration
{
    public static class RedisTestUtilities
    {
        ...
        /// </summary>
        public static async Task TestClusterConfiguration(RedisTestFixture fixture, string uniquePrefix, ILogger logger)
        {
        ...
        /// </summary>
        public static async Task TestHighAvailabilityConfiguration(RedisTestFixture fixture, string uniquePrefix, ILogger logger)
        {
