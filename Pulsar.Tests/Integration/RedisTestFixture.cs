...
namespace Pulsar.Tests.Integration
{
    public class RedisTestFixture : IAsyncLifetime
    {
        ...
        public ConnectionMultiplexer Redis => _redisConnection ?? throw new InvalidOperationException("Redis connection not initialized");
        ...
        public async Task InitializeAsync()
        {
            ...
            _logger.LogInformation("Connected to Redis test container at {ConnectionString}", connectionString);
