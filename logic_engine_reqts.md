...
1. **Rule Definitions (JSON/YAML/DSL)**:
   Pulsar’s rules start as human-readable definitions in a structured language (JSON or similar lamguage supporting a specialized DSL). These rules:
