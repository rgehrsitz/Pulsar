...
namespace Pulsar.Benchmarks
{
    ...
    public class RuleEvaluationBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            {
                File.WriteAllText(Path.Combine(_outputPath, "Generated", file.FileName), file.Content);
            }
            ...
            try
            {
                ...
                if (!compileSuccess)
                {
                    Console.WriteLine("Warning: Failed to compile generated code. Benchmark will be skipped.");
                    return;
                }
                
                // Load the compiled assembly
                var assemblyPath = Path.Combine(_outputPath, "bin", "Debug", "net9.0", "BenchmarkGenerated.dll");
                if (!File.Exists(assemblyPath))
                {
                    Console.WriteLine($"Warning: Assembly not found at {assemblyPath}. Benchmark will be skipped.");
                    return;
                }
                ...
                var ruleCoordinatorType = assembly.GetType("BenchmarkGenerated.Generated.RuleCoordinator");
                if (ruleCoordinatorType == null)
                {
                    Console.WriteLine("Warning: RuleCoordinator type not found. Benchmark will be skipped.");
                    return;
                }
        ...
        public void Cleanup()
        {
            ...
            if (Directory.Exists(_outputPath))
            {
                ...
                {
                    Console.WriteLine($"Warning: Failed to clean up benchmark directory: {_outputPath}");
                }
            }
        }
  ...
  <PropertyGroup>
    ...
    <Nullable>enable</Nullable>
                ...
                File.WriteAllText(Path.Combine(_outputPath, "BenchmarkGenerated.csproj"), projectContent);
